...
#nullable enable
        public global::Keycloak.Client.Models.OAuthClientRepresentation_access? Access { get; set; }
#nullable restore
#else
        public global::Keycloak.Client.Models.OAuthClientRepresentation_access Access { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Keycloak.Client.Models.OAuthClientRepresentation_attributes? Attributes { get; set; }
#nullable restore
#else
        public global::Keycloak.Client.Models.OAuthClientRepresentation_attributes Attributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Keycloak.Client.Models.OAuthClientRepresentation_authenticationFlowBindingOverrides? AuthenticationFlowBindingOverrides { get; set; }
#nullable restore
#else
        public global::Keycloak.Client.Models.OAuthClientRepresentation_authenticationFlowBindingOverrides AuthenticationFlowBindingOverrides { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Keycloak.Client.Models.ResourceServerRepresentation? AuthorizationSettings { get; set; }
#nullable restore
#else
        public global::Keycloak.Client.Models.ResourceServerRepresentation AuthorizationSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Keycloak.Client.Models.OAuthClientRepresentation_claims? Claims { get; set; }
#nullable restore
#else
        public global::Keycloak.Client.Models.OAuthClientRepresentation_claims Claims { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Keycloak.Client.Models.OAuthClientRepresentation_registeredNodes? RegisteredNodes { get; set; }
#nullable restore
#else
        public global::Keycloak.Client.Models.OAuthClientRepresentation_registeredNodes RegisteredNodes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Keycloak.Client.Models.OAuthClientRepresentation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Keycloak.Client.Models.OAuthClientRepresentation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Keycloak.Client.Models.OAuthClientRepresentation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Keycloak.Client.Models.OAuthClientRepresentation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "access", n => { Access = n.GetObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_access>(global::Keycloak.Client.Models.OAuthClientRepresentation_access.CreateFromDiscriminatorValue); } },
                { "adminUrl", n => { AdminUrl = n.GetStringValue(); } },
                { "alwaysDisplayInConsole", n => { AlwaysDisplayInConsole = n.GetBoolValue(); } },
                { "attributes", n => { Attributes = n.GetObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_attributes>(global::Keycloak.Client.Models.OAuthClientRepresentation_attributes.CreateFromDiscriminatorValue); } },
                { "authenticationFlowBindingOverrides", n => { AuthenticationFlowBindingOverrides = n.GetObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_authenticationFlowBindingOverrides>(global::Keycloak.Client.Models.OAuthClientRepresentation_authenticationFlowBindingOverrides.CreateFromDiscriminatorValue); } },
                { "authorizationServicesEnabled", n => { AuthorizationServicesEnabled = n.GetBoolValue(); } },
                { "authorizationSettings", n => { AuthorizationSettings = n.GetObjectValue<global::Keycloak.Client.Models.ResourceServerRepresentation>(global::Keycloak.Client.Models.ResourceServerRepresentation.CreateFromDiscriminatorValue); } },
                { "baseUrl", n => { BaseUrl = n.GetStringValue(); } },
                { "bearerOnly", n => { BearerOnly = n.GetBoolValue(); } },
                { "claims", n => { Claims = n.GetObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_claims>(global::Keycloak.Client.Models.OAuthClientRepresentation_claims.CreateFromDiscriminatorValue); } },
                ...
                { "registeredNodes", n => { RegisteredNodes = n.GetObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_registeredNodes>(global::Keycloak.Client.Models.OAuthClientRepresentation_registeredNodes.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_access>("access", Access);
            writer.WriteStringValue("adminUrl", AdminUrl);
            writer.WriteBoolValue("alwaysDisplayInConsole", AlwaysDisplayInConsole);
            writer.WriteObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_attributes>("attributes", Attributes);
            writer.WriteObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_authenticationFlowBindingOverrides>("authenticationFlowBindingOverrides", AuthenticationFlowBindingOverrides);
            writer.WriteBoolValue("authorizationServicesEnabled", AuthorizationServicesEnabled);
            writer.WriteObjectValue<global::Keycloak.Client.Models.ResourceServerRepresentation>("authorizationSettings", AuthorizationSettings);
            writer.WriteStringValue("baseUrl", BaseUrl);
            writer.WriteBoolValue("bearerOnly", BearerOnly);
            writer.WriteObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_claims>("claims", Claims);
            ...
            writer.WriteObjectValue<global::Keycloak.Client.Models.OAuthClientRepresentation_registeredNodes>("registeredNodes", RegisteredNodes);
