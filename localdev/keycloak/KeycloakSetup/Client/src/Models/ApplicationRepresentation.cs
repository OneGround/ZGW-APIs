...
#nullable enable
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_access? Access { get; set; }
#nullable restore
#else
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_access Access { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_attributes? Attributes { get; set; }
#nullable restore
#else
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_attributes Attributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_authenticationFlowBindingOverrides? AuthenticationFlowBindingOverrides { get; set; }
#nullable restore
#else
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_authenticationFlowBindingOverrides AuthenticationFlowBindingOverrides { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::KeycloakSetup.Client.Models.ResourceServerRepresentation? AuthorizationSettings { get; set; }
#nullable restore
#else
        public global::KeycloakSetup.Client.Models.ResourceServerRepresentation AuthorizationSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_claims? Claims { get; set; }
#nullable restore
#else
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_claims Claims { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_registeredNodes? RegisteredNodes { get; set; }
#nullable restore
#else
        public global::KeycloakSetup.Client.Models.ApplicationRepresentation_registeredNodes RegisteredNodes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::KeycloakSetup.Client.Models.ApplicationRepresentation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::KeycloakSetup.Client.Models.ApplicationRepresentation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::KeycloakSetup.Client.Models.ApplicationRepresentation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::KeycloakSetup.Client.Models.ApplicationRepresentation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "access", n => { Access = n.GetObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_access>(global::KeycloakSetup.Client.Models.ApplicationRepresentation_access.CreateFromDiscriminatorValue); } },
                { "adminUrl", n => { AdminUrl = n.GetStringValue(); } },
                { "alwaysDisplayInConsole", n => { AlwaysDisplayInConsole = n.GetBoolValue(); } },
                { "attributes", n => { Attributes = n.GetObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_attributes>(global::KeycloakSetup.Client.Models.ApplicationRepresentation_attributes.CreateFromDiscriminatorValue); } },
                { "authenticationFlowBindingOverrides", n => { AuthenticationFlowBindingOverrides = n.GetObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_authenticationFlowBindingOverrides>(global::KeycloakSetup.Client.Models.ApplicationRepresentation_authenticationFlowBindingOverrides.CreateFromDiscriminatorValue); } },
                { "authorizationServicesEnabled", n => { AuthorizationServicesEnabled = n.GetBoolValue(); } },
                { "authorizationSettings", n => { AuthorizationSettings = n.GetObjectValue<global::KeycloakSetup.Client.Models.ResourceServerRepresentation>(global::KeycloakSetup.Client.Models.ResourceServerRepresentation.CreateFromDiscriminatorValue); } },
                { "baseUrl", n => { BaseUrl = n.GetStringValue(); } },
                { "bearerOnly", n => { BearerOnly = n.GetBoolValue(); } },
                { "claims", n => { Claims = n.GetObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_claims>(global::KeycloakSetup.Client.Models.ApplicationRepresentation_claims.CreateFromDiscriminatorValue); } },
                ...
                { "registeredNodes", n => { RegisteredNodes = n.GetObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_registeredNodes>(global::KeycloakSetup.Client.Models.ApplicationRepresentation_registeredNodes.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_access>("access", Access);
            writer.WriteStringValue("adminUrl", AdminUrl);
            writer.WriteBoolValue("alwaysDisplayInConsole", AlwaysDisplayInConsole);
            writer.WriteObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_attributes>("attributes", Attributes);
            writer.WriteObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_authenticationFlowBindingOverrides>("authenticationFlowBindingOverrides", AuthenticationFlowBindingOverrides);
            writer.WriteBoolValue("authorizationServicesEnabled", AuthorizationServicesEnabled);
            writer.WriteObjectValue<global::KeycloakSetup.Client.Models.ResourceServerRepresentation>("authorizationSettings", AuthorizationSettings);
            writer.WriteStringValue("baseUrl", BaseUrl);
            writer.WriteBoolValue("bearerOnly", BearerOnly);
            writer.WriteObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_claims>("claims", Claims);
            ...
            writer.WriteObjectValue<global::KeycloakSetup.Client.Models.ApplicationRepresentation_registeredNodes>("registeredNodes", RegisteredNodes);
