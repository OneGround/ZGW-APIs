...
namespace OneGround.ZGW.Besluiten.DataModel.Migrations
{
    ...
    public partial class add_table_audittrail_deltas : Migration
    {
        ...
        {
            migrationBuilder.AddColumn<bool>(name: "legacy_audittrail", table: "besluiten", type: "boolean", nullable: false, defaultValue: true);
            ...
            migrationBuilder.CreateIndex(name: "IX_audittrail_deltas_aanmaakdatum", table: "audittrail_deltas", column: "aanmaakdatum");

            migrationBuilder.CreateIndex(
                name: "IX_audittrail_deltas_hoofdobject_id_resource_id_versie",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "legacy_audittrail", table: "besluiten");
        }
    }
}
