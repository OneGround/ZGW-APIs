...
namespace OneGround.ZGW.Besluiten.DataModel.Migrations
{
    ...
    [Migration("20260513060421_modify_besluit_identificatie_unique_index")]
    partial class modify_besluit_identificatie_unique_index
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneGround.ZGW.Besluiten.DataModel.Authorization.TempBesluitAuthorization", b =>
                {
                    b.Property<string>("BesluitType")
                        .HasColumnType("text");

                    b.HasKey("BesluitType");

                    b.ToTable("TempBesluitAuthorization", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });

                    b.ToView("TempBesluitAuthorization", (string)null);
                });
            ...
            modelBuilder.Entity("OneGround.ZGW.Besluiten.DataModel.Besluit", b =>
                {
                    ...
                    b.HasIndex("Owner", "Identificatie")
                        .IsUnique()
                        .HasDatabaseName("IX_besluiten_owner_identificatie")
                        .HasFilter("creationtime > '2026-05-13T06:04:20Z'");
