namespace OneGround.ZGW.Catalogi.Web.Contracts.v1._3;
...
public class ApiRoutes
{
    ...
    {
        public const string GetAll = Base + "/zaakobjecttypen";

        public const string Get = Base + "/zaakobjecttypen/{id}";

        public const string Create = Base + "/zaakobjecttypen";

        public const string Update = Base + "/zaakobjecttypen/{id}";

        public const string Delete = Base + "/zaakobjecttypen/{id}";
    }
}
