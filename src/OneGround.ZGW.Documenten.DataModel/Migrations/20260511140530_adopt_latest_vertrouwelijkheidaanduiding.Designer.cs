...
namespace OneGround.ZGW.Documenten.DataModel.Migrations
{
    ...
    [Migration("20260511140530_adopt_latest_vertrouwelijkheidaanduiding")]
    partial class adopt_latest_vertrouwelijkheidaanduiding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OneGround.ZGW.Documenten.DataModel.EnkelvoudigInformatieObject", b =>
                {
                    ...
                    b.Property<int?>("LatestVertrouwelijkheidAanduiding")
                        .HasColumnType("integer")
                        .HasColumnName("latest_vertrouwelijkheidaanduiding");
            ...
            modelBuilder.Entity("OneGround.ZGW.Documenten.DataModel.EnkelvoudigInformatieObjectVersie", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Id"), new[] { "Owner", "Vertrouwelijkheidaanduiding", "EnkelvoudigInformatieObjectId", "Bronorganisatie", "Identificatie" });

                    b.HasIndex("Identificatie");

                    b.HasIndex("Inhoud");

                    b.HasIndex("Trefwoorden");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Trefwoorden"), "gin");

                    b.HasIndex("Owner", "Id", "Vertrouwelijkheidaanduiding");

                    b.HasIndex("Owner", "Identificatie", "Versie")
                        .IsUnique()
