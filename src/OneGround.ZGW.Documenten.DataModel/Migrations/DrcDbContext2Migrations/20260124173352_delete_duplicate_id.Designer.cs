...
namespace OneGround.ZGW.Documenten.DataModel.Migrations.DrcDbContext2Migrations
{
    ...
    [Migration("20260124173352_delete_duplicate_id")]
    partial class delete_duplicate_id
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OneGround.ZGW.Documenten.DataModel.EnkelvoudigInformatieObject2", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Id"), new[] { "Owner", "Vertrouwelijkheidaanduiding", "EnkelvoudigInformatieObjectLockId" });
                    ...
                    b.HasIndex("Owner", "EnkelvoudigInformatieObjectLockId", "Versie", "Vertrouwelijkheidaanduiding")
                        .IsDescending(false, false, true, false);

                    b.HasIndex("Owner", "Inhoud", "Vertrouwelijkheidaanduiding", "EnkelvoudigInformatieObjectLockId")
                        .IsDescending(false, false, true, false)
                        .HasDatabaseName("IX_enkelvoudiginformatieobjecten_2_owner_inhoud_vertrouwelijk~1")
                        .HasFilter("Bestandsomvang IS NOT NULL");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Owner", "Inhoud", "Vertrouwelijkheidaanduiding", "EnkelvoudigInformatieObjectLockId"), new[] { "Bestandsomvang" });
