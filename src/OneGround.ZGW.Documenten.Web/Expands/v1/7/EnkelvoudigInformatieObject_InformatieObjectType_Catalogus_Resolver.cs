...
public class EnkelvoudigInformatieObject_InformatieObjectType_Catalogus_Resolver : IExpandResolver<EnkelvoudigInformatieObjectGetResponseDto>
{
    ...
    public EnkelvoudigInformatieObject_InformatieObjectType_Catalogus_Resolver(
