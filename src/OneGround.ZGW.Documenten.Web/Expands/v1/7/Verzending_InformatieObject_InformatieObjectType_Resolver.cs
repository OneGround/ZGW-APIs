...
public class Verzending_InformatieObject_InformatieObjectType_Resolver : IExpandResolver<VerzendingResponseDto>
{
    ...
    public Verzending_InformatieObject_InformatieObjectType_Resolver(
