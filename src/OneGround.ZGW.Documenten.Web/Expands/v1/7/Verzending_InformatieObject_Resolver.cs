...
public class Verzending_InformatieObject_Resolver : IExpandResolver<VerzendingResponseDto>
{
    private readonly IEntityUriService _uriService;
    private readonly IMapper _mapper;
    private readonly IMediator _mediator;

    public Verzending_InformatieObject_Resolver(IMapper mapper, IEntityUriService uriService, IMediator mediator)
    {
        _mapper = mapper;
