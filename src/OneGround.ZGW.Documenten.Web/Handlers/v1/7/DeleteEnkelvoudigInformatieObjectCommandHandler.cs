    ...
    public async Task<CommandResult> Handle(DeleteEnkelvoudigInformatieObjectCommand request, CancellationToken cancellationToken)
    {
        ...
        var (enkelvoudigInformatieObject, status) = await _concurrencyRetryPipeline.ExecuteWithResultAsync(
            async (token) =>
            {
                ...
                IQueryable<EnkelvoudigInformatieObject> enkelvoudigInformatieObjectQuery = _context
                ...
                if (alleenIsGereedVoorPublicatie)
                {
                    ...
                    enkelvoudigInformatieObjectQuery = enkelvoudigInformatieObjectQuery.Where(v =>
                ...
                enkelvoudigInformatieObjectQuery = enkelvoudigInformatieObjectQuery
                ...
                var _enkelvoudigInformatieObject = await enkelvoudigInformatieObjectQuery
                    .AsSplitQuery()
                    .AsNoTracking()
                ...
                if (_enkelvoudigInformatieObject == null)
                {
                    ...
                    var exists = await existsQuery.AnyAsync(e => e.Id == request.Id, token);
