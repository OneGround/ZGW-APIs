...
public class DomainToResponseRegister : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        config
            .NewConfig<BestandsDeel, BestandsDeelResponseDto>()
            .Map(dest => dest.Url, src => MapsterUrlResolver.ResolveUrl(src))
            .Map(dest => dest.Lock, src => src.EnkelvoudigInformatieObjectVersie.InformatieObject.Lock);
    }

    // Ported verbatim from v1.1's MapLatestEnkelvoudigInformatieObjectVersieResponse.Process(...) (_uriService -> uriService parameter).
    ...
    // Ported verbatim from v1.1's MapLatestEnkelvoudigInformatieObjectVersieResponse.MapBestandsDeel(...) (_uriService -> uriService parameter).
    private static BestandsDeelResponseDto MapBestandsDeel(BestandsDeel bestandsdeel, IEntityUriService uriService)
    {
    ...
    // Ported verbatim from v1.1's MapDownloadLink.Process(...) (_uriService -> uriService parameter).
    ...
    // Ported verbatim from v1.1's MapLatestEnkelvoudigInformatieObjectVersieRequest.Process(...). No DI dependency.
