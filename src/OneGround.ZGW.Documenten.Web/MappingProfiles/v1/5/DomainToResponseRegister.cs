...
public class DomainToResponseRegister : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        config
            .NewConfig<BinnenlandsCorrespondentieAdres, BinnenlandsCorrespondentieAdresDto>()
        ...
        config
            .NewConfig<BuitenlandsCorrespondentieAdres, BuitenlandsCorrespondentieAdresDto>()
        ...
        config
            .NewConfig<CorrespondentiePostadres, CorrespondentiePostAdresDto>()
        ...
        config
            .NewConfig<Verzending, VerzendingRequestDto>()
            .Map(dest => dest.InformatieObject, src => MapsterUrlResolver.ResolveUrl(src.InformatieObject))
            .Map(dest => dest.Betrokkene, src => src.Betrokkene)
            .Map(dest => dest.AardRelatie, src => src.AardRelatie.ToString())
            .Map(dest => dest.Toelichting, src => src.Toelichting)
    ...
    // Ported verbatim from v1.5's MapLatestEnkelvoudigInformatieObjectVersieResponse.Process(...) (_uriService -> uriService parameter).
    ...
    // Ported verbatim from v1.5's MapLatestEnkelvoudigInformatieObjectVersieResponse.MapBestandsDeel(...) (_uriService -> uriService parameter).
    ...
    // Ported verbatim from v1.5's MapDownloadLink.Process(...) (_uriService -> uriService parameter).
    ...
    // Ported verbatim from v1.5's MapLatestEnkelvoudigInformatieObjectVersieRequest.Process(...). No DI dependency.
