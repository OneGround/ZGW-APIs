...
namespace OneGround.ZGW.Zaken.Contracts.v1._7.Requests;

// Note: v1._7-specific because it adds "fields" (field-selection, mutually exclusive with
// "expand") -- everything else is identical to v1._5.Requests.ZaakSearchRequestDto, whose
// IZakenCommonSearchableFields is reused directly rather than duplicated.
