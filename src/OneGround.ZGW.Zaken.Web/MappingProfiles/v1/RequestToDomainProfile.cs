...
public class RequestToDomainProfile : Profile
{
    public RequestToDomainProfile()
    {
        ...
        CreateMap<OverigeZaakObjectDto, OverigeZaakObject>()
            ...
            .ForMember(dest => dest.ModifiedBy, opt => opt.Ignore())
            .ForMember(dest => dest.Owner, opt => opt.Ignore())
            .ForMember(dest => dest.OverigeData, opt => opt.MapFrom(src => src.OverigeData.ToString(Formatting.None)));
        ...
        CreateMap<NatuurlijkPersoonZaakRolDto, NatuurlijkPersoonZaakRol>()
            ...
            .ForMember(dest => dest.InpBsnHash, opt => opt.Ignore())
            .ForMember(dest => dest.InpBsnHashKeyVersion, opt => opt.Ignore())
