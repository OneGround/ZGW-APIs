...
namespace Roxit.ZGW.Notificaties.DataModel.Migrations
{
    ...
    [Migration("20250506154915_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Roxit.ZGW.Notificaties.DataModel.Abonnement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Roxit.ZGW.Notificaties.DataModel.AbonnementKanaal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Roxit.ZGW.Notificaties.DataModel.FilterValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Roxit.ZGW.Notificaties.DataModel.Kanaal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Roxit.ZGW.Notificaties.DataModel.AbonnementKanaal", b =>
                {
                    b.HasOne("Roxit.ZGW.Notificaties.DataModel.Abonnement", "Abonnement")
                        .WithMany("AbonnementKanalen")
                        .HasForeignKey("AbonnementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Roxit.ZGW.Notificaties.DataModel.Kanaal", "Kanaal")
                        .WithMany("AbonnementKanalen")
            ...
            modelBuilder.Entity("Roxit.ZGW.Notificaties.DataModel.FilterValue", b =>
                {
                    b.HasOne("Roxit.ZGW.Notificaties.DataModel.AbonnementKanaal", "AbonnementKanaal")
                        .WithMany("Filters")
