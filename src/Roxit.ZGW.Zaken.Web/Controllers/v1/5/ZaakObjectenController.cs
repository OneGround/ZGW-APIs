...
using Roxit.ZGW.Zaken.Web.Validators.v1._5.ZaakObject;
using Swashbuckle.AspNetCore.Annotations;
using AdresZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.AdresZaakObjectRequestDto;
using BuurtZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.BuurtZaakObjectRequestDto;
using GemeenteZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.GemeenteZaakObjectRequestDto;
using KadastraleOnroerendeZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.KadastraleOnroerendeZaakObjectRequestDto;
using OverigeZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.OverigeZaakObjectRequestDto;
using PandZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.PandZaakObjectRequestDto;
using TerreinGebouwdObjectZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.TerreinGebouwdObjectZaakObjectRequestDto;
using WozWaardeZaakObjectRequestDto = Roxit.ZGW.Zaken.Contracts.v1.Requests.ZaakObject.WozWaardeZaakObjectRequestDto;
...
public class ZaakObjectenController : ZGWControllerBase
{
    ...
    )
    {
        ...
        var zaakObjectResponse = _mapper.Map<IEnumerable<ZaakObject>, List<ZaakObjectResponseDto>>(result.Result.PageResult);
    ...
    public async Task<IActionResult> GetAsync(Guid id)
    {
        ...
        var response = _mapper.Map<ZaakObject, ZaakObjectResponseDto>(result.Result);
    ...
    /// <response code="429">Too Many Requests</response>
    /// <response code="500">Internal Server Error</response>
    [HttpHead(ApiRoutes.ZaakObjecten.Get, Name = Operations.ZaakObjecten.ReadHead)]
    [Scope(AuthorizationScopes.Zaken.Read)]
    [ETagFilter]
    ...
    public async Task<IActionResult> UpdateAsync([FromBody] ZaakObjectRequestDto zaakobjectRequest, Guid id)
    {
        ...
        var zaakObjectResponse = _mapper.Map<ZaakObject, ZaakObjectResponseDto>(result.Result);
    ...
    public async Task<IActionResult> PartialUpdateAsync([FromBody] JObject partialZaakObjectRequest, Guid id)
    {
        ...
        var zaakObjectResponse = _mapper.Map<ZaakObject, ZaakObjectResponseDto>(resultUpd.Result);
