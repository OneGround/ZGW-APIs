...
public class ZtcMapsterCompileTests
{
    ...
    /// so it must be caught here rather than at runtime. ZTC is the most exposed service in the repo:
    /// ZaakType owns StatusType, RolType, ResultaatType, Eigenschap, ZaakObjectType and
    /// ZaakTypeInformatieObjectType, every one of which points back at ZaakType, and the
