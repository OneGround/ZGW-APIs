...
using Xunit;
using AnchorController = OneGround.ZGW.Notificaties.Web.Controllers.v1.AbonnementController;

namespace OneGround.ZGW.Notificaties.WebApi.UnitTests.Authorization;

/// <summary>
/// Every controller action in the Nrc API must carry a scope attribute, or an explicit
...
/// </summary>
public class NrcScopeCoverageTests
{
    [Fact]
