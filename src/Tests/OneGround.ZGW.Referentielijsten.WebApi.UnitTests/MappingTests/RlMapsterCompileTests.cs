...
public class RlMapsterCompileTests
{
    /// <summary>
    ...
    /// </para>
    /// <para>
    /// RL has no EF entities of its own today, so nothing here is currently cyclic - this guards the
    /// service against acquiring one later, at the cost of one fast test.
    /// </para>
    /// <para>
